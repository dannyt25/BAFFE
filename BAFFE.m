function [Ftrack,Prob]=BAFFE(signal,fs,Tw,st,fL,fH,Ength,Pth,J)
% *****************************************************************************
% The BAFFE function tracks the pitch or fundemental frequency of a
...
% 
% Usage: All input parameters defined by the user.
%        [Ftrack,Prob]=BAFFE(signal,fs,Tw,st,fL,fH,Ength,Pth,J)
%
% Usage: Default transitional cost used.
%        [Ftrack,Prob]=BAFFE(signal,fs,Tw,st,fL,fH,Ength,Pth)
%
% Usage: Default correlation peak threshold and transitional cost used.
%        [Ftrack,Prob]=BAFFE(signal,fs,Tw,st,fL,fH,Ength)
%
% Usage: Default voiced/unvoiced threshold, correlation peak threshold,
%        and transitional cost used.
%        [Ftrack,Prob]=BAFFE(signal,fs,Tw,st,fL,fH)
% 
% Inputs:
% signal    :  Input Signal
...
% J         :  Maximum allowable transition cost (typcial value : 0.25)
%
% Outputs:
% Ptrack    :  Pitch track
% Prob      :  Confidence
